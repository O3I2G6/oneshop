document.addEventListener('DOMContentLoaded', function(){
    ...
    const slideItemWidth = slideItem.offsetWidth + 10;
    ...
    let nextSlide =  () => {
      for (const key in slideItems) {
        if (Object.hasOwnProperty.call(slideItems, key)) {
          const element = slideItems[key];
          slideItems[key].classList.remove('active')
        }
      }
