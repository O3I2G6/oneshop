document.addEventListener('DOMContentLoaded', function(){
    ...
    //auto Slider
     btnPrev = document.querySelector('#btnSlideLeft');
     btnNext = document.querySelector('#btnSlideRight');
     slideList = document.querySelector('.slider-list');
     slideItem = document.querySelector('.slider-item');
     slideItemAll = document.querySelectorAll('.slider-item').length;
     slideItemWidth = slideItem.offsetWidth + 10;
     slideItemWidthMax = (slideItemAll-1)*(slideItemWidth + 10);
    let vitri = 0;
    const duration = 6000;
