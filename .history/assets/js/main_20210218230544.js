document.addEventListener('DOMContentLoaded', function(){
    ...
    let continueAutoSlide = () => {
      if(isClicked === true){
        setTimeout(setInterval(nextSlide, 5000), 0);
      }else{
    ...
    btnSlideRight.addEventListener('click', nextSlideClick);

    btnSlideLeft.addEventListener('click', prevSlideClick);
